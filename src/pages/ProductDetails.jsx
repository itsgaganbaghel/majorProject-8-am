        ...
        <>
            {Products.filter((info) => info.id == id).map((value, i) => {
                return (
                    <section
                        key={i}
                        class="shop-card w-full relative bg-white pt-[12vh]  px-[80px] "
                    >
                        <div class="shop-item w-[100%]  flex flex-wrap">
                            ...
                            <div class="shop-item-01 w-[48%] pt-[20px] ">
                                ...
                                <button
                                    ...
                                    class=" rounded-lg  ml-10 font-bold text-white bg-[#088178] py-[12px] px-[30px] text-[1.2rem] cursor-pointer "
                                >
                                    Add to cart
                                </button>
